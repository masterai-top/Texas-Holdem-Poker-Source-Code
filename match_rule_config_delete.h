#ifndef __MATCH_RULE_CONFIG_DELETE_H__
#define __MATCH_RULE_CONFIG_DELETE_H__
class MatchRuleConfigDeleteRequest
{
public:
	MatchRuleConfigDeleteRequest(const string& json) {
...
class MatchRuleConfigDeleteResponse
{
public:
	MatchRuleConfigDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
